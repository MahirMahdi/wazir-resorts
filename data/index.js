...
export const theMirage = {
  ...
  benefits: [
    "The Grill Pit – Restaurant",
    "Andalucia – Buffet",
    "Oasis Pool & Bar – Bar",
    "Equestrian Lounge – Bar",
    "Horse & Hound – Bar",
    "Polo Bar – Bar",
  ],
  logo: "/assets/mirage.png",
  link: "/the-mirage",
};

export const metropolitanHotel = {
  ...
  logo: "/assets/metropolitan-hotel.png",
  link: "/metropolitan-hotel",
};

export const habtoorPalace = {
  name: "Habtoor Palace",
  room_types: [
    {
      name: "Ambassador Suite",
  ...
  benefits: [
    "Grand Grill – Restaurant (Reservation Required)",
    "Al Dhiyafa Grand Kitchen – Buffet",
    "Al Manara – Bar",
    "Acaia Lounge – Bar",
    "Polo Bar – Bar",
    "The Underground Pub – Bar",
    "Pool Bar – Bar",
    "Andrea’s Beach Club – Beach Club (Reservation Required)",
  ],
  logo: "/assets/habtoor-palace.png",
  link: "/habtoor-palace",
};
...
export const vHotel = {
  ...
  benefits: [
    "The Atrium: The Rose & Crown – English pub",
    "Level Seven – Buffet",
    "Sunset Lounge by Lifestyle – Bar",
    "V Lounge – Bar",
    "V Deck – Pool Bar",
  ],
  logo: "/assets/v-hotel.png",
  link: "/v-hotel",
};

export const habtoorGrand = {
  name: "Habtoor Grand",
  room_types: [
    {
...
function mergeRooms(hotel) {
  const hotelName = hotel.name;
  const link = hotel.link;
  const roomTypes = hotel.room_types.map((roomType) => ({
    hotelName,
    link,
    ...roomType,
  }));
...
function getRandomizedRooms(hotels) {
