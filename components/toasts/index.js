...
export default function Toast() {
  return (
    <div className="toast toast-top toast-end z-[100]">
      <div className="alert alert-success flex flex-col items-start space-y-0">
        <span className="text-white">
          Successfully added to bookings list!
          <Link
            href="/my-bookings"
            className="flex underline underline-offset-2 items-center gap-x-1 text-containerColor font-dmSans font-light"
          >
            View bookings
            <svg
              width="18px"
